...
const repoLink = "https://github.com/sozonome/feigne";
  ...
  return (
    <Box textAlign="center">
      <Box transform="scale(0.85)">
        <Flex marginY={4} justifyContent="center" gap={2}>
          <Link
            ...
            href="https://vercel.com/import/git?s=https://github.com/sozonome/feigne"
          >
          ...
          <Link
            ...
            isExternal
            rel="noopener noreferrer"
            href="https://app.netlify.com/start/deploy?repository=https://github.com/sozonome/feigne"
          >
            <Image
      ...
      <Flex justifyContent="center" alignItems="center" gap={2}>
        <Button
          as="a"
          href="https://github.com/sozonome/feigne/generate"
          target="_blank"
          size="sm"
        >
          Use This Template
